...
window.addEventListener('load', function() {
  ...
  if (savedData) {
    ...
    document.getElementById('data0').value = data[0].value;
    document.getElementById('data1').value = data[1].value;
    document.getElementById('data2').value = data[2].value;
    document.getElementById('data3').value = data[3].value;
    document.getElementById('data4').value = data[4].value;
    document.getElementById('data5').value = data[5].value;
    document.getElementById('data6').value = data[6].value;
    document.getElementById('data7').value = data[7].value;
